...
class NullSerializerTest {
    ...
    public static Stream<Arguments> getCanSerialize() {
        ...
        return Stream.of(
                ...
                Arguments.arguments(ImmutableProperty.build("a", Double.MAX_VALUE), false),
                ...
                Arguments.arguments(ImmutableProperty.build("a", nullObject), true),
    ...
    void canSerialize(Property property, boolean expected) {
        ...
        assertEquals(expected, nullSerializer.canSerialize(property));
    }

    @Test
    void serialize() {
        Object nullObject = null;
        Property property = ImmutableProperty.build("a", nullObject);
        NullSerializer nullSerializer = new NullSerializer();

        SerializedProperty serializedProperty = nullSerializer.serialize(property);

        assertEquals(PropertyType.NULL, serializedProperty.getType());
    ...
    @Test
    void priority() {
        assertEquals(6000, new NullSerializer().getPriority());
    }
}